...
The DNA sequence is given as a non-empty string ... consisting of N characters. 
There are M queries, which are given in non-empty arrays P and Q, each consisting of M integers. 
The K-th query requires you to find the minimal impact factor 
of nucleotides contained in the DNA sequence ...
...
#https://stackoverflow.com/questions/22836576/codility-genomic-range-query
